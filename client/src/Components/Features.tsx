  ...
  return (
    <section id='features' className='py-20 px-4 bg-black bg-opacity-50'>
      <div className='max-w-6xl mx-auto'>
        <h2 className='text-3xl md:text-4xl font-bold mb-12 text-center bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-white'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
          {features.map((feature, index) => (
            <div
              key={index}
              className='text-center p-6 rounded-lg bg-purple-900 bg-opacity-50 hover:bg-opacity-75 transition-all'
            >
              {feature.icon}
